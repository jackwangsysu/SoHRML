...
class Recommender(object):
    ...
    def _get_common_params(self):
        ...
        self.fism_like, self.cml_like = True if 'fism_like' in self.configs else False, True if 'cml_like' in self.configs else False # Training instances are constructed in a special way in this two types of models
        self.is_pairwise = self.configs['is_pairwise'] # Pointwise or pairwise learning
        ...
        self.saved_model_dir = self.configs['saved_dir']
